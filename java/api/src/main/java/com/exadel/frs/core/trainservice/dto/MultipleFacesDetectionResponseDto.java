...
public class MultipleFacesDetectionResponseDto extends FaceProcessResponse {
    ...
    public static HashMapResponseDto buildResponse(final MultipleFacesDetectionResponseDto[] responses) {
        var result = new HashMapResponseDto();
